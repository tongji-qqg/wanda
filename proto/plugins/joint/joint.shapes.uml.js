...
joint.shapes.uml.Database = joint.shapes.basic.Generic.extend({
    ...
    updateEvents: function() {
        var col = this.get('events');
        var div = this.attr('.uml-state-events')
        for(var i=0;i<col.length;i++){

        }
        this.attr('.uml-state-events/text', this.get('events').join('\n'));
        console.log(this.attr('.uml-state-events'));
    },
